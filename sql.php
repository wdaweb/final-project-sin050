<?php
session_start();
$db = new PDO("mysql:host=127.0.0.1;dbname=s1080414;charset=utf8", "root", "");
...
// banner輪播
// $reer=select("q1t6_img", "dpy=1");
// $t6_img="";
// foreach ($reer as $data) $t6_img .= $data['img']."　　";
